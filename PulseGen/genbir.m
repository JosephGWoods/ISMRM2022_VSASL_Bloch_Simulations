...
%      nbir  - RF resolution
%
% Converted from CFMRIs spep code by Joseph G. Woods, CFMRI, UCSD, June 2020
...
for ii = 0:(n-1)
    ...
    rho.birleft(ii+1)   = tanh(zeta*(1-t));
    theta.birleft(ii+1) = modp(ptmp);
    theta.birmid(n-ii)  = modp(ptmp+pi);
